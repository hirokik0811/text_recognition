...
def classify_text(data, training = False):
    N_STEPS = 10000
    BATCH_SIZE = 200
    INPUT_SIZE = 32 # all input image batches should be 32 by 32
    OUTPUT_SIZE = 2 # text or not
    ...
    FC_SIZE = 1024
    """
    Classify a 32x32 image to text or non-text
    Convolutional Neural Network with 2 convolutional layers and 2 average pooling layers
    """
