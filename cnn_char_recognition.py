...
OUTPUT_SIZE = 62
N1 = 115 # number of filters used for first convolutional layer and average pooling layer
N2 = 720 # number of filters used for second convolutional layer and average pooling layer
CONV1_FILTER_SIZE = 8
